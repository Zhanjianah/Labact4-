...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($bookObj->isBookExist($title))
        $duplication_err = "This book title already exists in the database";

    if(empty($title_err) && empty($author_err) && empty($genre_err) 
        && empty($publication_year_err) && empty($publisher_err) && empty($copies_err) && empty($duplication_err)) {
